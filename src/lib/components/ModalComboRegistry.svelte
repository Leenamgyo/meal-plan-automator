<script lang="ts">
    ...
    import { createCombo } from "$lib/services/combos";
    import { showSuccess } from "$lib/stores";
    import { hangulIncludes } from "$lib/utils/hangul";
    import type { MenuItem, Combo } from "$lib/types/models";

    export let menuItems: MenuItem[] = [];

    const dispatch = createEventDispatcher<{ saved: Combo; close: void }>();
